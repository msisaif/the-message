...
export default {
    ...
    props: {
        ...
        ayahOfTheDay: {
            type: Object,
            default: {
                text: `‘প্রত্যেক প্রাণীকে মৃত্যুর স্বাদ গ্রহণ করতে হবে৷ আর আমি ভালো ও মন্দ অবস্থার মধ্যে ফেলে তোমাদের সবাইকে পরীক্ষা করছি,  শেষ পর্যন্ত তোমাদের আমার দিকে ফিরে আসতে হবে।’ (সূরা আম্বিয়া ৩৫)`,
                reference: "সূরা আম্বিয়া, আয়াত: ৩৫",
            },
        },
        hadithOfTheDay: {
            type: Object,
            default: {
                text: `আবূ হুরাইরাহ্ (রা.) হতে বর্ণিত, নবী সল্লাল্লাহু আলাইহি ওয়াসাল্লাম বলেছেন, এমন এক যুগ আসবে, যখন মানুষ পরোয়া করবে না যে, সে কোথা হতে সম্পদ উপার্জন করল, হালাল হতে না হারাম হতে। (বুখারী: ২০৫৯)`,
                reference: "সহীহ বুখারি - ২০৫৯",
            },
        },
    },
