        ...
        <form @submit.prevent="submit" class="">
            <div class="mb-6">
                <Select
                    ...
                    required
                >
                    <option value="2022-04-23">২১ রমজান</option>
                    <option value="2022-04-24">২২ রমজান</option>
                    <option value="2022-04-25">২৩ রমজান</option>
                    <option value="2022-04-26">২৪ রমজান</option>
                    <option value="2022-04-27">২৫ রমজান</option>
                    <option value="2022-04-28">২৬ রমজান</option>
                    <option value="2022-04-29">২৭ রমজান</option>
                    <option value="2022-04-30">২৮ রমজান</option>
                    <option value="2022-05-01">২৯ রমজান</option>
                    <option value="2022-05-02">৩০ রমজান</option>
                </Select>
            </div>
    ...
    methods: {
        submit() {
            if (this.moduleAction == "store") {
                return this.form.post(this.route("ramadan-checklist.save"));
            }

            if (this.moduleAction == "update") {
                return this.form.put(
                    this.route("ramadan-checklist.update", this.data.sura.id)
                );
            }
        },
        selectDateHandler(event) {
            return (window.location.href = this.route(
                "ramadan-checklist.form",
                event.target.value
            ));
        },
    },
